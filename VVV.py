...
def o():
    ...
    if opt == '1':
        i()
    if None == '2':
        _HERON_('xdg-open https://www.facebook.com/Jahidul1223?mibextid=ZbWKwL')
        return None
    if None == '3':
        _HERON_('xdg-open https://youtube.com/channel/UCRedHPu_qhEpO9aLttjRKrg')
        return None
    if None == '4':
        _HERON_('xdg-open https://www.facebook.com/groups/452360276797465/?ref=share')
        return None
    if None == '0':
        _HERON_('exit')
        return None
...
def i():
    ...
    logo()
    heron('\033[1;92m─────────────────────────────────────────────────────')
    heron('\033[1;91m[\033[1;92m✔︎\033[1;91m]\033[1;32mBD CODE    - \033[1;32m016 \033[1;32m017 \033[1;32m018 \033[1;32m019')
    heron('\033[1;92m─────────────────────────────────────────────────────\n')
